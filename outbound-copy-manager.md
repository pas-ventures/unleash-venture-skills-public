...
### Ansprache Rules
- **Sie**: Steuerberater, Ärzte, Anwälte, professional-services firms — formal industries
- **Du**: Handwerker, Gastro, Fitness, trades & service practitioners — informal industries
...
- Acknowledge they're busy (niche-specific: phrase it in the way the prospect would say it themselves — "als {role} sitzt man nicht am Rechner" / "als {role} hat man keine Zeit")
